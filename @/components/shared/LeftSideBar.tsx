        ...
        <nav className="leftsidebar">
            <div className="flex flex-col gap-11">
                <Link to= "/" className="flex gap-5 items-center">
                    <img src="/assets/images/logo.svg" alt="logo pic" width={130} height={325} />
                </Link>
                <Link to= {`/profile/${user.id}`} className="flex gap-3 items-center">
                    <img src= { user.imageUrl ||"/assets/images/profile.png"} alt="Profile pic" className="h-14 w-14 rounded-full"/>
